rShiefSearch
    ...
    .filter('atomThumbnail', function($filter) {
        return function(input) {
            var thumbnailLink = _.findWhere(input.links, { rel: 'thumbnail' }) || _.findWhere(input.links, { rel: 'image' }) || _.findWhere(input.links, { type: 'image' }) || { href: 'http://placehold.it/96x96' };
